    ...
    if parsed_source.scheme == '':
        if not _pathlib.isabs(parsed_source.path):
            ...
            if parsed_start.scheme != '':
                ...
                print('make_absolute_href returns : ','{}://{}{}'.format(parsed_start.scheme, parsed_start.netloc, abs_path))
                return '{}://{}{}'.format(parsed_start.scheme, parsed_start.netloc, abs_path)
            else:
                print("make_absolute_href returns : ", abs_path)
                return abs_path
        else:
            print("make_absolute_href returns : ", source_href)
            return source_href
    else:
        print("make_absolute_href returns : ", source_href)
        return source_href
